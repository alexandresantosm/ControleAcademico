...
public class TestaAluno {
	...
	public static void main(String[] args) {
		...
		alunoService.addAluno("Alex", "123.456.789-11", "Rua A", "alex@email.com", "(85) 1456-7878", 
				123, SituacaoDoAluno.MATRICULADO, new Curso());
		
		cursoService.addCurso("SI");
		
		disciplinaService.addDisciplina("Calculo I");
		disciplinaService.addDisciplina("Calculo II");
		
		
		alunoService.addAluno("Maria", "120.888.999-00", "Rua B", "maria@email.com", "(85) 1456-1475", 
				456, SituacaoDoAluno.PENDENTE, new Curso());
		/*
		...
		*/
		...
		System.out.println(alunoService.getAluno(123).toString());
		System.out.println(cursoService.getCurso("SI").toString());
		System.out.println(disciplinaService.getListaDeDisciplina().toString());
		/*
